        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    ...
                    <a href="mailto:hello@stellarouter.co" className="footer-email">hello@stellarouter.co</a>
            ...
            {/* Big STELLAROUTER wordmark */}
            <div className="footer-bottom">
                <div className="footer-big-text">
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 1368 304" fill="none" className="footer-logo__svg"><text x="684" y="248" textAnchor="middle" textLength="1356" lengthAdjust="spacingAndGlyphs" fontFamily="'Epilogue', sans-serif" fontWeight="800" fontSize="300" fill="currentColor">stellarouter</text></svg>
                </div>
