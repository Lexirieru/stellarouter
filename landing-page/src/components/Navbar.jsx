...
export default function Navbar() {
    useEffect(() => {
        ...
        const cleanups = [];
        const logoStellarouter = document.querySelector('.logo-stellarouter');
        if (logoStellarouter) cleanups.push(initWiggle(logoStellarouter, WIGGLE_CONFIG.logoStellarouter));
