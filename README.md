...
| x402 agent door | ⏳ testnet only | upstream outage — the facilitator advertises a sponsor account silent since 10 Aug ([issue #47](https://github.com/OpenZeppelin/relayer-plugin-x402-facilitator/issues/47)) — [details & workarounds](docs/MAINNET-RUNBOOK.md#4c--known-blocker-x402-settlement-on-mainnet) |
